...
### Currently accepted
Current accepted work: **#110 Keep the chosen preset when canceling layout customization**. A PR must complete that issue's Acceptance through the normal product workflow.
